export default function Post(props: {
  ...
  return (
    <div className="flex flex-col w-[98%] max-w-screen-lg bg-[#04031c6e] rounded-2xl shadow-lg overflow-hidden text-">
      ...
      <h1 className="text-2xl s:text-3xl md:text-4xl self-center my-4 mx-3">{props.title}</h1>
      <img src={props.img} />
